...
USightPortalHUDWidget* ASightPortalPlayerController::ShowMainHUD()
{
    ...
    if (ActiveMainHUDWidget)
    {
        ...
        ActiveMainHUDWidget->OnUnitSearchOpened.AddUniqueDynamic(this, &ASightPortalPlayerController::OnHUDUnitSearchOpened);
        ActiveMainHUDWidget->OnUnitSearchClosed.AddUniqueDynamic(this, &ASightPortalPlayerController::OnHUDUnitSearchClosed);
    }
...
void ASightPortalPlayerController::OnHUDUnitSearchOpened()
{
    OnUnitSearchOpened.Broadcast();
    OnUnitSearchStateChanged(true);
}

void ASightPortalPlayerController::OnHUDUnitSearchClosed()
{
    OnUnitSearchClosed.Broadcast();
    OnUnitSearchStateChanged(false);
}
